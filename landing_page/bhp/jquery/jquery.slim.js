...
// Microsoft forgot to hump their bhp prefix (#9572)
...
// Return a bhp-prefixed property or undefined
function bhpPropName( name ) {

	// Check for bhp prefixed names
...
// Return a potentially-mapped jQuery.cssProps or bhp prefixed property
function finalPropName( name ) {
	var final = jQuery.cssProps[ name ] || bhpProps[ name ];
	...
	return bhpProps[ name ] = bhpPropName( name ) || name;
}
